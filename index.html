...
<section class="banner-area bannernya">
    ...
    <h3>| HOME |</h3>
    <h1>Welcome <span>:v</span></h1><button class="banner-btn btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
  More Info
</button>
